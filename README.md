...
**iVocab** is an application made to aid nonverbal children a way to communicate effectivly. Designed with the lowest possible *learning curve*, iVocab mimics Apple's iOS home user interface - that includes the *user changable* parallax wallpaper. 
