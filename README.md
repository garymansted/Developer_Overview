...
**iVocab** is an application made as an aid for nonverbal children providing them a way to communicate effectivly. Designed with the lowest possible *learning curve*, iVocab mimics Apple's iOS home user interface - right down to the *user changable* parallax wallpaper. 
