...
The CCC app utilises the iOS auto layout feature, along with frame based layouts, to dynamically scale and constrain the UI for all iOS devices currently availble.<br/> <br/>
